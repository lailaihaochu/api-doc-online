...
public class MyShiroRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		logger.info("执行:MyShiroRealm.doGetAuthenticationInfo()");
		// 获取用户的输入的账号.
		...
		SimpleAuthenticationInfo authenticationInfo = new SimpleAuthenticationInfo(u, // 用户名
				u.getPassword(), // 密码
				ByteSource.Util.bytes(u.getToken()), // salt=username+token
				getName() // realm name
		);
		...
		// getName() //realm name
		// );
		simpleAuthorizationInfo.addStringPermission("/project/list");
